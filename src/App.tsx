    ...
    <div>
      ...
      <div className="App">
        ...
        <div className="content">
          <div className="item">
            <a className="image-link glow" href="https://google.com" target="_blank" rel="noopener noreferrer">
          ...
          <div className="item">
            <a className="image-link glow" href="https://discord.com/users/449983218788204569" target="_blank" rel="noopener noreferrer">
